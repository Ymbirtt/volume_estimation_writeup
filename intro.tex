...
$$
\vol_n(RI) = \frac{R-h}{n} \vol_{n-1}(rB) + \vol_n(B) - \left(\frac{1}{2}\vol_n(rB) I_{\frac{2rh-h^2}{r^2}}\left(\frac{n+1}{2}, \frac{1}{2}\right)\right) %Cite http://docsdrive.com/pdfs/ansinet/ajms/2011/66-70.pdf
$$
...
A much faster algorithm than the one used does exist at this time. %cite simulated annealing
